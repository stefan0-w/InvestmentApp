...
function Form({route, method}) { //route is where we want to go when we submit the from (token route or register route) / method tells us if we are logging or registering
  ...
  return <form onSubmit={handleSubmit} className="form-container">
    ...
    <button className="from-button" type="submit">{name}</button>
  </form>
}
